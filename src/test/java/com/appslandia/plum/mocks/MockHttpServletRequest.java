...
public class MockHttpServletRequest implements HttpServletRequest {
  ...
  public boolean isUserInRole(String role) {
    ...
    return this.userRoles.stream().anyMatch(r -> role.equalsIgnoreCase(r));
  }
  ...
  public MockHttpServletRequest setUserPrincipal(Principal principal, Set<String> userRoles) {
