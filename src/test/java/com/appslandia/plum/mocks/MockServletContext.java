...
public class MockServletContext implements ServletContext {
  ...
  private static final Set<SessionTrackingMode> DEFAULT_SESSION_TRACKING_MODES = CollectionUtils
      .toUnmodifiableSet(SessionTrackingMode.COOKIE, SessionTrackingMode.URL, SessionTrackingMode.SSL);
  ...
  public String getContextPath() {
    Asserts.notNull(contextPath, "appDir is required.");
    return contextPath;
  }

  public String getAppDir() {
    Asserts.notNull(appDir, "appDir is required.");
    return appDir;
  }
  ...
  public Set<SessionTrackingMode> getEffectiveSessionTrackingModes() {
    return (sessionTrackingModes != null ? Collections.unmodifiableSet(sessionTrackingModes)
