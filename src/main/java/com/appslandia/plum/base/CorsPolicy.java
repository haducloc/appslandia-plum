 ...
 *
 */
public class CorsPolicy extends InitializingObject {
  ...
  public static final Set<String> SET_ANY = CollectionUtils.toUnmodifiableSet(CORS_ANY);
  ...
  public CorsPolicy setAllowOrigins(String multilineAllowOrigins) {
    ...
    if (origins.length > 0) {
      allowOrigins = CollectionUtils.addAll(new LinkedHashSet<>(), origins);
    }
    return this;
  }
  ...
  public CorsPolicy setAllowHeaders(String multilineAllowHeaders) {
    ...
    if (headers.length > 0) {
      allowHeaders = CollectionUtils.addAll(new CaseInsensitiveSet(new LinkedHashSet<>()), headers);
    }
    return this;
  }
  ...
  public CorsPolicy setExposeHeaders(String multilineExposeHeaders) {
    ...
    if (headers.length > 0) {
      exposeHeaders = CollectionUtils.addAll(new CaseInsensitiveSet(new LinkedHashSet<>()), headers);
    }
    return this;
  }
