 ...
 */
// @formatter:off
@Tag(name = "wrap", bodyContent = true, attributes = {
  @Attribute(name = "tag", type = String.class, required = true),
...
// @formatter:on
@FacesComponent(WrapUITag.COMPONENT_TYPE)
public class WrapUITag extends UITagBase {

  public static final String COMPONENT_TYPE = "appslandia.WrapUITag";
